...
while(T>0.01)
{
    ...
    if(rd1>=N)
    {
        ...
        if(A[a][b]==0&&A[(a+B[DD1][0]+L)%L][(b+B[DD1][1]+L)%L]==0&&A[(a+B[DD2][0]+L)%L][(b+B[DD2][1]+L)%L]==0)
        {
            ...
            int switch1=0,dk1=0,dk2=0,dk3=0,dk4=0,n0,n1,n2,n3;/*用来判断是不是风车构型*/
            ...
            if(A[(a+2*B[DD1][0]+L)%L][(b+2*B[DD1][1]+L)%L]>0)
            {
                ...
                dk1=B[DD1][0],dk2=B[DD1][1],dk3=B[(DD1+5)%6][0],dk4=B[(DD1+5)%6][1];
                if(A[(a+B[DD1][0]+2*dk1+L)%L][(b+B[DD1][1]+2*dk2+L)%L]<-N&&A[(a+B[DD1][0]+2*dk3+L)%L][(b+B[DD1][1]+2*dk4+L)%L]<-N)
                {
                    n0=A[(a+B[DD1][0]+2*dk1+L)%L][(b+B[DD1][1]+2*dk2+L)%L];
                    n1=-n0-N-1;
                    n2=A[(a+B[DD1][0]+2*dk3+L)%L][(b+B[DD1][1]+2*dk4+L)%L];
                    n3=-n2-N-1;
                    if(D2[n1][0]==(DD1+4)%6&&D2[n3][0]==(DD1+2)%6)
                    {
                        switch1=1;
                        cout<<"k  "<<endl;
                    }
            ...
            if(A[(a+2*B[DD2][0]+L)%L][(b+2*B[DD2][1]+L)%L]>0)
            {
                ...
                dk1=B[DD2][0],dk2=B[DD2][1],dk3=B[(DD2+5)%6][0],dk4=B[(DD2+5)%6][1];
                if(A[(a+B[DD2][0]+2*dk1+L)%L][(b+B[DD2][1]+2*dk2+L)%L]<-N&&A[(a+B[DD2][0]+2*dk3+L)%L][(b+B[DD2][1]+2*dk4+L)%L]<-N)
                {
                    n0=A[(a+B[DD2][0]+2*dk1+L)%L][(b+B[DD2][1]+2*dk2+L)%L];
                    n1=-n0-N-1;
                    n2=A[(a+B[DD2][0]+2*dk3+L)%L][(b+B[DD2][1]+2*dk4+L)%L];
                    n3=-n2-N-1;
                    if(D2[n1][0]==(DD1+4)%6&&D2[n3][0]==(DD1+2)%6)
                    {
                        switch1=1;
